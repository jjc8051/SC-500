...
//-------------------------------------------------------------------------------------------------
	...
	#define BUNYO			10
	#define SENSOR			11
	#define SORTING_FRAGEMNT	21			// 포유자돈, 비육돈
//-------------------------------------------------------------------------------------------------
...
// #define OLD_Date_Addr	0x0003				// 이전 날짜 주소		// Byte
...
#define Gateway_Gukbun_Addr	1				// 게이트웨이 국번 주소		// Byte
#define Gateway_GWID_Addr	2				// 게이트웨이 ID   주소		// Byte
#define OLD_Date_Addr		3				// 이전 날짜 주소		// Byte

#define Cell_ID_Addr		4				// 로드셀 ID 주소		// Byte
#define Cell_CNT_Addr		5				// 로드셀 갯수 설정 값 주소	// Byte

#define Cell_Capa_Addr		6				// 로드셀 용량 값 주소		// word
#define Cell_IN_S_Addr		8				// 로드셀 입구체중 값 주소	// word
#define Cell_Interval_Addr	10				// 로드셀 보정 값 주소		// word

#define Cell_RO_Addr		12				// 로드셀 출력 값 주소		// dword
...
#define Admit_Weight		50				// 인정체중(500g)

...
// 	volatile uint16_t Data[300];				// 측정 값 버퍼 300개
	volatile uint16_t Count;				// 측정 횟수

	volatile int8_t RoomNum;				// 방 번호
	volatile int8_t StalNum;				// 스톨 번호

	volatile int8_t Year[300];				// 스톨 번호
	volatile int8_t Month[300];				// 스톨 번호
	volatile int8_t Date[300];				// 스톨 번호
	volatile int8_t Hour[300];				// 스톨 번호
	volatile int8_t Min[300];				// 스톨 번호
	volatile int8_t Sec[300];				// 스톨 번호

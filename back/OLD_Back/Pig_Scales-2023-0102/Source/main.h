...
=======
>>>>>>> 37084d9a3f556cf7c84333cf20a704335f1b4c28
//=================================================================================================
//		PORT A Control Bit
//=================================================================================================
...
#define Cell_AUTO_Addr		7				// 스톨 번호 설정 값 주소		// Byte   7

#define Cell_Capa_Addr		8				// 로드셀 용량 값 주소		// Word   8,  9
#define Cell_IN_S_Addr		10				// 로드셀 입구체중 값 주소	// Word  10, 11
#define Cell_Interval_Addr	12				// 로드셀 보정 값 주소		// Word  12, 13

#define Cell_RO_Addr		14				// 로드셀 출력 값 주소		// DWord 14, 15, 16, 17
...
#define MEASURE_AUTO		32				// 자동 측정			// Byte  32

#define MEASURE_LENGTH	12					// 측정 기록 길이
=======
// #define Gateway_Gukbun_Addr	1				// 게이트웨이 국번 주소		// Byte 1
#define Gateway_GWID_Addr	2				// 게이트웨이 ID   주소		// Byte 2
#define OLD_Date_Addr		3				// 날짜 주소			// Byte 3

#define Cell_ID_1_Addr		4				// 1번 로드셀 ID 주소		// Byte 4
#define Cell_ID_2_Addr		5				// 2번 로드셀 ID 주소		// Byte 5
#define Cell_ID_3_Addr		6				// 3번 로드셀 ID 주소		// Byte 6

#define Cell_CNT_1_Addr		7				// 1번 로드셀 갯수 설정 값 주소	// Byte 7
#define Cell_CNT_2_Addr		8				// 2번 로드셀 갯수 설정 값 주소	// Byte 8
#define Cell_CNT_3_Addr		9				// 3번 로드셀 갯수 설정 값 주소	// Byte 9

#define Cell_Capa_1_Addr	10				// 1번 로드셀 용량 값 주소	// word 10,11
#define Cell_Capa_2_Addr	12				// 2번 로드셀 용량 값 주소	// word 12,13
#define Cell_Capa_3_Addr	14				// 3번 로드셀 용량 값 주소	// word 14,15

#define Cell_IN_S_1_Addr	16				// 1번 로드셀 입구체중 값 주소	// word 16,17
#define Cell_IN_S_2_Addr	18				// 2번 로드셀 입구체중 값 주소	// word 18,19
#define Cell_IN_S_3_Addr	20				// 3번 로드셀 입구체중 값 주소	// word 20,21

#define Cell_RO_1_Addr		22				// 1번 로드셀 출력 값 주소	// dword 22,23,24,25
#define Cell_RO_2_Addr		26				// 2번 로드셀 출력 값 주소	// dword 26,27,28,29
#define Cell_RO_3_Addr		30				// 3번 로드셀 출력 값 주소	// dword 30,31,32,33
>>>>>>> 37084d9a3f556cf7c84333cf20a704335f1b4c28
...
//=================================================================================================
<<<<<<< HEAD
#define FW_VER			41				// 펌웨어 버젼
#define Admit_Weight		50				// 인정체중(50x10g)
...
uint8_t Zero_Buff;						// Zero_Buff 변수 선언
uint8_t Zero_Count;						// Zero Count 변수 선언
uint8_t Value_Count;						// Value Count 변수 선언

uint32_t Maximum_Value;						// Maximum_Value 변수 선언
uint32_t Minimum_Value;						// Minimum_Value 변수 선언
uint32_t Sum_Value;						// Old_Value 변수 선언

uint8_t Time_Count;						// 시간 표시 용 변수 설정
uint8_t Sec_Count;						// 초 저장 용 변수 설정
uint8_t SECOND;							// 이전 시간(초)용 변수 설정

uint8_t SECOND;							// 이전 시간(초)용 변수 설정

uint8_t Data_Number;						// Data 번호
uint8_t Room_Number;						// 방 번호
uint8_t Stal_Number;						// 스톨 번호
uint8_t EepCnt;
=======
#define FW_VER			33				// 펌웨어 버젼
#define Admit_Weight		50				// 인정체중(100g)

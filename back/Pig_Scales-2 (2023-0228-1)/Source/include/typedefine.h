...
// 	volatile int32_t Old_Value;				// 이전 측정 값
	volatile int32_t Old_Value_0;				// 이전 측정 값 0
	volatile int32_t Old_Value_1;				// 이전 측정 값 1
	volatile int32_t Old_Value_2;				// 이전 측정 값 2
	volatile int32_t Old_Value_3;				// 이전 측정 값 3
	volatile int32_t Old_Value_4;				// 이전 측정 값 4
	volatile int32_t Old_Value_5;				// 이전 측정 값 5
	volatile int32_t Old_Value_6;				// 이전 측정 값 6
	volatile int32_t Old_Value_7;				// 이전 측정 값 7
	volatile int32_t Old_Value_8;				// 이전 측정 값 8
	volatile int32_t Old_Value_9;				// 이전 측정 값 9

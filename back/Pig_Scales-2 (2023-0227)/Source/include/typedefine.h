...
// 	volatile int32_t Old_Value;				// 이전 측정 값 1
	volatile int32_t Old_Value_1;				// 이전 측정 값 2
	volatile int32_t Old_Value_2;				// 이전 측정 값 3
	volatile int32_t Old_Value_3;				// 이전 측정 값 4
	volatile int32_t Old_Value_4;				// 이전 측정 값 5
	volatile int32_t Old_Value_5;				// 이전 측정 값 6

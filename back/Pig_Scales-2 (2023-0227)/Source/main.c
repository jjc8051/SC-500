//=================================================================================================
//		ProductName 	:	Pig_Scales V4.3 SC-500
//=================================================================================================
//		File  Name	:	main.c
...
// 	uint32_t Old_Value = CELL.Old_Value;					// 로드셀 Old_Value 값
	uint8_t cnt = 5;							// OK_Count 갯수
//-------------------------------------------------------------------------------------------------
	uint32_t Old_Value = (CELL.Old_Value_1 + CELL.Old_Value_2 + CELL.Old_Value_3 + CELL.Old_Value_4 + CELL.Old_Value_5)/5;
// 	CELL.Old_Value_3 = CELL.Old_Value_4;
// 	CELL.Old_Value_4 = CELL.Old_Value_5;
...
// 	printf("Old_Value %ld \r\n", Old_Value);
	if(Value)								// 측정체중이 있으면
	{
		...
		{								// 이전체중이 측정체중과 인증체중(50x10g)을 더한값과 같거나 작고 인증체중(50x10g)을 뺀값과 같거나 크면서 이전체중과 같으면
			...
			if(OK_Count == cnt)					// 측정체중 OK Count 가 3보다 크면
			{
...
//   			CELL.Value = Old_Value = (CELL.Old_Value_1 + CELL.Old_Value_2 + CELL.Old_Value_3 + CELL.Old_Value_4 + CELL.Old_Value_5)/5;
...
// 			CELL.Old_Value = 0;					// 이전측정체중 초기화
			CELL.Old_Value_1 = 0;					// 이전측정체중 초기화
			CELL.Old_Value_2 = 0;					// 이전측정체중 초기화
			CELL.Old_Value_3 = 0;					// 이전측정체중 초기화
			CELL.Old_Value_4 = 0;					// 이전측정체중 초기화
			CELL.Old_Value_5 = 0;					// 이전측정체중 초기화
			CELL.Value = Value;

...
extern _RTC_T RTC_T;								// RTC_T 구조체명 선언
...
extern _TIMER Timer;								// Timer 구조체명 선언
...
extern _RoadCell CELL;								// CELL 구조체명 선언
...
extern _SaveData SAVE;								// SAVE 구조체명 선언

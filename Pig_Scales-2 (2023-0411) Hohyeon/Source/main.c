...
//			펌웨어 버젼 표시 V4.6으로 변경
//
//	2021-0411	호현용으로 장비 번호를 21번(0x15)로 바꾸어서 컴파일	
//
//=================================================================================================
#include <main.h>
#include <avr/fuse.h>
...
// 		if(Rx3_Buff[cnt] == STX_Iontec && Rx3_Buff[cnt + 1] == PC2CTL && Rx3_Buff[cnt + 2] == 0x01 && Rx3_Buff[cnt + 4] == 0 && Rx3_Buff[cnt + 9] == ETX_Iontec)
		if(Rx3_Buff[cnt] == STX_Iontec && Rx3_Buff[cnt + 1] == PC2CTL && Rx3_Buff[cnt + 2] == 0x15 && Rx3_Buff[cnt + 4] == 0 && Rx3_Buff[cnt + 9] == ETX_Iontec)
		{//			STX			       PC2CTL			     이동형			실시간정보			ETX
			Rx_LED_ON;						// RX LED ON
			ChkSum = 0;						// ChkSum 초기화
...
// 		else if(Rx3_Buff[cnt] == STX_Iontec && Rx3_Buff[cnt + 1] == PC2CTL && Rx3_Buff[cnt + 2] == 0x01 && Rx3_Buff[cnt + 4] == 7 && Rx3_Buff[cnt + 31] == ETX_Iontec)
		else if(Rx3_Buff[cnt] == STX_Iontec && Rx3_Buff[cnt + 1] == PC2CTL && Rx3_Buff[cnt + 2] == 0x15 && Rx3_Buff[cnt + 4] == 7 && Rx3_Buff[cnt + 31] == ETX_Iontec)
		{//			     STX			    PC2CTL			  이동형		설정정보(입구체중)		       ETX
			Rx_LED_ON;							// RX LED ON
			ChkSum = 0;							// ChkSum 초기화
